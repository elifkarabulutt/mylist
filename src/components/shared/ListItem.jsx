...
const handleCheckbox=() =>setChecked(!isChecked)
    return (
        <TouchableOpacity onPress={handleCheckbox} className={`border-[2px] border-white ${isChecked && 'border-main border-[2px]'}  bg-white rounded-[6px] px-[10px] py-[8px] flex-row justify-between items-center mt-[10px]`}>

...
<View className='mt-5'>
    ...
    <View className='flex-row gap-[7px] items-center '>
      <Entypo name="chevron-right" size={16} color="#343440" />
      <Text className='text-primary text-[13px]'>Liste sayını sanırsız yap.</Text>
    </View>
    <View className='flex-row gap-[7px] items-center mt-[10px]'>
      <Entypo name="chevron-right" size={16} color="#343440" />
